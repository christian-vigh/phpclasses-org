...
class  IniFile		// extends  Object
   {
	...
	public static function  LoadFromFile ( $inifile, $load_option = self::LOAD_ANY, $separator = '=', $options = self::OPTION_NONE )
	   {
		global		$Application ;
		...
		for  ( $i = 0 ; $i  <  $argc ; $i ++ )
		   {
			...
			if  ( is_array ( $arg )  ||  
					is_a ( $arg, 'VariableStore' )  ||  
					is_a ( $arg, 'AssociativeArray' ) )
			   {
			...
			// None of the above...
				...
				throw ( new InvalidArgumentException ( "The argument #" . ( $i + 1 ) . " specified for the SetVariableStore() " .
